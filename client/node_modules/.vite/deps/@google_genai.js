import { n as __toESM, t as __commonJSMin } from "./chunk-FDOR9p9I.js";
...
var import_p_retry = /* @__PURE__ */ __toESM((/* @__PURE__ */ __commonJSMin(((exports, module) => {
...
function setValueByPath(data, keys, value) {
	...
	} else if (keyToSet === "_self" && typeof value === "object" && value !== null && !Array.isArray(value)) Object.assign(data, value);
...
function createPartFromFunctionResponse(id, name, response, parts = []) {
	return { functionResponse: Object.assign({
		id,
		name,
		response
...
var GenerateContentResponse = class {
	...
	*/
	get executableCode() {
		...
		const executableCode = (_h = (_g = (_f = (_e = this.candidates) === null || _e === void 0 ? void 0 : _e[0]) === null || _f === void 0 ? void 0 : _f.content) === null || _g === void 0 ? void 0 : _g.parts) === null || _h === void 0 ? void 0 : _h.filter((part) => part.executableCode).map((part) => part.executableCode).filter((executableCode) => executableCode !== void 0);
	...
	*/
	get codeExecutionResult() {
		...
		const codeExecutionResult = (_h = (_g = (_f = (_e = this.candidates) === null || _e === void 0 ? void 0 : _e[0]) === null || _f === void 0 ? void 0 : _f.content) === null || _g === void 0 ? void 0 : _g.parts) === null || _h === void 0 ? void 0 : _h.filter((part) => part.codeExecutionResult).map((part) => part.codeExecutionResult).filter((codeExecutionResult) => codeExecutionResult !== void 0);
...
function flattenTypeArrayToAnyOf(typeList, resultingSchema) {
	...
	if (listWithoutNull.length === 1) resultingSchema["type"] = Object.values(Type).includes(listWithoutNull[0].toUpperCase()) ? listWithoutNull[0].toUpperCase() : Type.TYPE_UNSPECIFIED;
		...
		for (const i of listWithoutNull) resultingSchema["anyOf"].push({ "type": Object.values(Type).includes(i.toUpperCase()) ? i.toUpperCase() : Type.TYPE_UNSPECIFIED });
	}
}
...
function resourceName(client, resourceName, resourcePrefix, splitsAfterPrefix = 1) {
	...
	if (client.isVertexAI()) if (resourceName.startsWith("projects/")) return resourceName;
	else if (resourceName.startsWith("locations/")) return `projects/${client.getProject()}/${resourceName}`;
	else if (resourceName.startsWith(`${resourcePrefix}/`)) return `projects/${client.getProject()}/locations/${client.getLocation()}/${resourceName}`;
	else if (shouldAppendPrefix) return `projects/${client.getProject()}/locations/${client.getLocation()}/${resourcePrefix}/${resourceName}`;
	else return resourceName;
	if (shouldAppendPrefix) return `${resourcePrefix}/${resourceName}`;
	return resourceName;
}
...
function tBatchJobSource(client, src) {
	...
	else if (/^projects\/[^/]+\/locations\/[^/]+\/datasets\/[^/]+$/.test(src)) sourceObj = {
		format: "vertex-dataset",
		vertexDatasetName: src
	};
	...
	if (client.isVertexAI()) {
		if (mldevSourcesCount > 0 || vertexSourcesCount !== 1) throw new Error("Exactly one of `gcsUri`, `bigqueryUri`, or `vertexDatasetName` must be set for Vertex AI.");
...
function authConfigToMldev$4(fromObject) {
	...
	if (getValueByPath(fromObject, ["apiKeyConfig"]) !== void 0) throw new Error("apiKeyConfig parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	if (getValueByPath(fromObject, ["authType"]) !== void 0) throw new Error("authType parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	if (getValueByPath(fromObject, ["googleServiceAccountConfig"]) !== void 0) throw new Error("googleServiceAccountConfig parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	if (getValueByPath(fromObject, ["httpBasicAuthConfig"]) !== void 0) throw new Error("httpBasicAuthConfig parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	if (getValueByPath(fromObject, ["oauthConfig"]) !== void 0) throw new Error("oauthConfig parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	if (getValueByPath(fromObject, ["oidcConfig"]) !== void 0) throw new Error("oidcConfig parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	return toObject;
}
...
function batchJobDestinationFromVertex(fromObject) {
	...
	if (fromVertexDataset != null) setValueByPath(toObject, ["vertexDataset"], vertexMultimodalDatasetDestinationFromVertex(fromVertexDataset));
	return toObject;
}
function batchJobDestinationToVertex(fromObject) {
	...
	if (getValueByPath(fromObject, ["fileName"]) !== void 0) throw new Error("fileName parameter is only supported in Gemini Developer API mode, not in Gemini Enterprise Agent Platform mode.");
	if (getValueByPath(fromObject, ["inlinedResponses"]) !== void 0) throw new Error("inlinedResponses parameter is only supported in Gemini Developer API mode, not in Gemini Enterprise Agent Platform mode.");
	if (getValueByPath(fromObject, ["inlinedEmbedContentResponses"]) !== void 0) throw new Error("inlinedEmbedContentResponses parameter is only supported in Gemini Developer API mode, not in Gemini Enterprise Agent Platform mode.");
	const fromVertexDataset = getValueByPath(fromObject, ["vertexDataset"]);
	if (fromVertexDataset != null) setValueByPath(toObject, ["vertexMultimodalDatasetDestination"], vertexMultimodalDatasetDestinationToVertex(fromVertexDataset));
	return toObject;
}
...
function batchJobFromVertex(fromObject) {
	...
	if (fromOutputInfo != null) setValueByPath(toObject, ["outputInfo"], fromOutputInfo);
	return toObject;
}
function batchJobSourceFromVertex(fromObject) {
	...
	if (fromBigqueryUri != null) setValueByPath(toObject, ["bigqueryUri"], fromBigqueryUri);
	const fromVertexDatasetName = getValueByPath(fromObject, ["vertexMultimodalDatasetSource", "datasetName"]);
	if (fromVertexDatasetName != null) setValueByPath(toObject, ["vertexDatasetName"], fromVertexDatasetName);
	return toObject;
}
function batchJobSourceToMldev(apiClient, fromObject) {
	const toObject = {};
	if (getValueByPath(fromObject, ["format"]) !== void 0) throw new Error("format parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	if (getValueByPath(fromObject, ["gcsUri"]) !== void 0) throw new Error("gcsUri parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	if (getValueByPath(fromObject, ["bigqueryUri"]) !== void 0) throw new Error("bigqueryUri parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	...
	if (getValueByPath(fromObject, ["vertexDatasetName"]) !== void 0) throw new Error("vertexDatasetName parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	return toObject;
}
function batchJobSourceToVertex(fromObject) {
	...
	if (getValueByPath(fromObject, ["fileName"]) !== void 0) throw new Error("fileName parameter is only supported in Gemini Developer API mode, not in Gemini Enterprise Agent Platform mode.");
	if (getValueByPath(fromObject, ["inlinedRequests"]) !== void 0) throw new Error("inlinedRequests parameter is only supported in Gemini Developer API mode, not in Gemini Enterprise Agent Platform mode.");
	const fromVertexDatasetName = getValueByPath(fromObject, ["vertexDatasetName"]);
	if (fromVertexDatasetName != null) setValueByPath(toObject, ["vertexMultimodalDatasetSource", "datasetName"], fromVertexDatasetName);
	return toObject;
}
function blobToMldev$4(fromObject) {
	...
	if (getValueByPath(fromObject, ["displayName"]) !== void 0) throw new Error("displayName parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	const fromMimeType = getValueByPath(fromObject, ["mimeType"]);
	if (fromMimeType != null) setValueByPath(toObject, ["mimeType"], fromMimeType);
	return toObject;
}
...
function createBatchJobConfigToMldev(fromObject, parentObject) {
	...
	if (getValueByPath(fromObject, ["dest"]) !== void 0) throw new Error("dest parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	const fromWebhookConfig = getValueByPath(fromObject, ["webhookConfig"]);
	if (parentObject !== void 0 && fromWebhookConfig != null) setValueByPath(parentObject, ["batch", "webhookConfig"], fromWebhookConfig);
	return toObject;
}
function createBatchJobConfigToVertex(fromObject, parentObject) {
	...
	if (getValueByPath(fromObject, ["webhookConfig"]) !== void 0) throw new Error("webhookConfig parameter is only supported in Gemini Developer API mode, not in Gemini Enterprise Agent Platform mode.");
	return toObject;
}
...
function embedContentConfigToMldev$1(fromObject, parentObject) {
	...
	if (getValueByPath(fromObject, ["mimeType"]) !== void 0) throw new Error("mimeType parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	if (getValueByPath(fromObject, ["autoTruncate"]) !== void 0) throw new Error("autoTruncate parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	if (getValueByPath(fromObject, ["documentOcr"]) !== void 0) throw new Error("documentOcr parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	if (getValueByPath(fromObject, ["audioTrackExtraction"]) !== void 0) throw new Error("audioTrackExtraction parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	return toObject;
}
...
function functionCallToMldev$4(fromObject) {
	...
	const fromName = getValueByPath(fromObject, ["name"]);
	if (fromName != null) setValueByPath(toObject, ["name"], fromName);
	if (getValueByPath(fromObject, ["partialArgs"]) !== void 0) throw new Error("partialArgs parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	if (getValueByPath(fromObject, ["willContinue"]) !== void 0) throw new Error("willContinue parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	return toObject;
}
function functionCallingConfigToMldev$2(fromObject) {
	...
	if (getValueByPath(fromObject, ["streamFunctionCallArguments"]) !== void 0) throw new Error("streamFunctionCallArguments parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	return toObject;
}
function generateContentConfigToMldev$1(apiClient, fromObject, parentObject) {
	...
	if (getValueByPath(fromObject, ["routingConfig"]) !== void 0) throw new Error("routingConfig parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	if (getValueByPath(fromObject, ["modelSelectionConfig"]) !== void 0) throw new Error("modelSelectionConfig parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	...
	if (getValueByPath(fromObject, ["labels"]) !== void 0) throw new Error("labels parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	...
	if (getValueByPath(fromObject, ["audioTimestamp"]) !== void 0) throw new Error("audioTimestamp parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	...
	if (fromEnableEnhancedCivicAnswers != null) setValueByPath(toObject, ["enableEnhancedCivicAnswers"], fromEnableEnhancedCivicAnswers);
	if (getValueByPath(fromObject, ["modelArmorConfig"]) !== void 0) throw new Error("modelArmorConfig parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	const fromServiceTier = getValueByPath(fromObject, ["serviceTier"]);
	if (parentObject !== void 0 && fromServiceTier != null) setValueByPath(parentObject, ["serviceTier"], fromServiceTier);
	return toObject;
}
function generateContentResponseFromMldev$1(fromObject) {
	...
	if (fromModelStatus != null) setValueByPath(toObject, ["modelStatus"], fromModelStatus);
	return toObject;
}
...
function googleSearchToMldev$4(fromObject) {
	...
	if (getValueByPath(fromObject, ["blockingConfidence"]) !== void 0) throw new Error("blockingConfidence parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	if (getValueByPath(fromObject, ["excludeDomains"]) !== void 0) throw new Error("excludeDomains parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
...
function imageConfigToMldev$1(fromObject) {
	...
	if (getValueByPath(fromObject, ["personGeneration"]) !== void 0) throw new Error("personGeneration parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	if (getValueByPath(fromObject, ["prominentPeople"]) !== void 0) throw new Error("prominentPeople parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	if (getValueByPath(fromObject, ["outputMimeType"]) !== void 0) throw new Error("outputMimeType parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	if (getValueByPath(fromObject, ["outputCompressionQuality"]) !== void 0) throw new Error("outputCompressionQuality parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	if (getValueByPath(fromObject, ["imageOutputOptions"]) !== void 0) throw new Error("imageOutputOptions parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	return toObject;
}
...
function listBatchJobsConfigToMldev(fromObject, parentObject) {
	...
	if (getValueByPath(fromObject, ["filter"]) !== void 0) throw new Error("filter parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	return toObject;
}
...
function partToMldev$4(fromObject) {
	...
	if (fromToolResponse != null) setValueByPath(toObject, ["toolResponse"], fromToolResponse);
	const fromPartMetadata = getValueByPath(fromObject, ["partMetadata"]);
	if (fromPartMetadata != null) setValueByPath(toObject, ["partMetadata"], fromPartMetadata);
	return toObject;
}
function safetySettingToMldev$3(fromObject) {
	...
	if (getValueByPath(fromObject, ["method"]) !== void 0) throw new Error("method parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
...
function toolConfigToMldev$2(fromObject) {
	...
	if (fromIncludeServerSideToolInvocations != null) setValueByPath(toObject, ["includeServerSideToolInvocations"], fromIncludeServerSideToolInvocations);
	return toObject;
}
function toolToMldev$4(fromObject) {
	const toObject = {};
	if (getValueByPath(fromObject, ["retrieval"]) !== void 0) throw new Error("retrieval parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	...
	if (getValueByPath(fromObject, ["enterpriseWebSearch"]) !== void 0) throw new Error("enterpriseWebSearch parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	...
	if (getValueByPath(fromObject, ["parallelAiSearch"]) !== void 0) throw new Error("parallelAiSearch parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
...
function vertexMultimodalDatasetDestinationFromVertex(fromObject) {
	...
	if (fromBigqueryDestination != null) setValueByPath(toObject, ["bigqueryDestination"], fromBigqueryDestination);
	const fromDisplayName = getValueByPath(fromObject, ["displayName"]);
	if (fromDisplayName != null) setValueByPath(toObject, ["displayName"], fromDisplayName);
	return toObject;
}
function vertexMultimodalDatasetDestinationToVertex(fromObject) {
	...
	if (fromBigqueryDestination != null) setValueByPath(toObject, ["bigqueryDestination", "outputUri"], fromBigqueryDestination);
	const fromDisplayName = getValueByPath(fromObject, ["displayName"]);
	if (fromDisplayName != null) setValueByPath(toObject, ["displayName"], fromDisplayName);
	return toObject;
}
	...
	constructor(apiClient) {
		...
		*/
		this.createEmbeddings = async (params) => {
			...
			if (this.apiClient.isVertexAI()) throw new Error("Gemini Enterprise Agent Platform (previously known as Vertex AI) does not support batches.createEmbeddings.");
		...
		if (this.apiClient.isVertexAI()) {
			...
			response = this.apiClient.request({
				...
				return httpResponse.json().then((jsonResponse) => {
					...
					response.sdkHttpResponse = { headers: httpResponse.headers };
					return response;
				});
			});
			return response.then((apiResponse) => {
...
function codeExecutionResultToVertex$3(fromObject) {
	...
	if (fromOutcome != null) setValueByPath(toObject, ["outcome"], fromOutcome);
	const fromOutput = getValueByPath(fromObject, ["output"]);
	if (fromOutput != null) setValueByPath(toObject, ["output"], fromOutput);
	if (getValueByPath(fromObject, ["id"]) !== void 0) throw new Error("id parameter is only supported in Gemini Developer API mode, not in Gemini Enterprise Agent Platform mode.");
	return toObject;
}
...
function createCachedContentConfigToMldev(fromObject, parentObject) {
	...
	if (getValueByPath(fromObject, ["kmsKeyName"]) !== void 0) throw new Error("kmsKeyName parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	return toObject;
}
function createCachedContentConfigToVertex(fromObject, parentObject) {
	...
	const fromSystemInstruction = getValueByPath(fromObject, ["systemInstruction"]);
	if (parentObject !== void 0 && fromSystemInstruction != null) setValueByPath(parentObject, ["systemInstruction"], contentToVertex$3(tContent(fromSystemInstruction)));
	const fromTools = getValueByPath(fromObject, ["tools"]);
	if (parentObject !== void 0 && fromTools != null) {
		let transformedList = fromTools;
		if (Array.isArray(transformedList)) transformedList = transformedList.map((item) => {
	...
	const fromToolConfig = getValueByPath(fromObject, ["toolConfig"]);
	if (parentObject !== void 0 && fromToolConfig != null) setValueByPath(parentObject, ["toolConfig"], toolConfigToVertex$1(fromToolConfig));
...
function executableCodeToVertex$3(fromObject) {
	...
	if (fromLanguage != null) setValueByPath(toObject, ["language"], fromLanguage);
	if (getValueByPath(fromObject, ["id"]) !== void 0) throw new Error("id parameter is only supported in Gemini Developer API mode, not in Gemini Enterprise Agent Platform mode.");
	return toObject;
}
...
function mcpServerToVertex$2(fromObject) {
	const toObject = {};
	if (getValueByPath(fromObject, ["name"]) !== void 0) throw new Error("name parameter is only supported in Gemini Developer API mode, not in Gemini Enterprise Agent Platform mode.");
	if (getValueByPath(fromObject, ["streamableHttpTransport"]) !== void 0) throw new Error("streamableHttpTransport parameter is only supported in Gemini Developer API mode, not in Gemini Enterprise Agent Platform mode.");
	return toObject;
}
...
function partToVertex$3(fromObject) {
	...
	if (fromMediaResolution != null) setValueByPath(toObject, ["mediaResolution"], fromMediaResolution);
	const fromCodeExecutionResult = getValueByPath(fromObject, ["codeExecutionResult"]);
	if (fromCodeExecutionResult != null) setValueByPath(toObject, ["codeExecutionResult"], codeExecutionResultToVertex$3(fromCodeExecutionResult));
	const fromExecutableCode = getValueByPath(fromObject, ["executableCode"]);
	if (fromExecutableCode != null) setValueByPath(toObject, ["executableCode"], executableCodeToVertex$3(fromExecutableCode));
	const fromFileData = getValueByPath(fromObject, ["fileData"]);
	...
	const fromVideoMetadata = getValueByPath(fromObject, ["videoMetadata"]);
	if (fromVideoMetadata != null) setValueByPath(toObject, ["videoMetadata"], fromVideoMetadata);
	if (getValueByPath(fromObject, ["toolCall"]) !== void 0) throw new Error("toolCall parameter is only supported in Gemini Developer API mode, not in Gemini Enterprise Agent Platform mode.");
	if (getValueByPath(fromObject, ["toolResponse"]) !== void 0) throw new Error("toolResponse parameter is only supported in Gemini Developer API mode, not in Gemini Enterprise Agent Platform mode.");
	if (getValueByPath(fromObject, ["partMetadata"]) !== void 0) throw new Error("partMetadata parameter is only supported in Gemini Developer API mode, not in Gemini Enterprise Agent Platform mode.");
	return toObject;
}
...
function toolConfigToVertex$1(fromObject) {
	...
	if (fromRetrievalConfig != null) setValueByPath(toObject, ["retrievalConfig"], fromRetrievalConfig);
	const fromFunctionCallingConfig = getValueByPath(fromObject, ["functionCallingConfig"]);
	if (fromFunctionCallingConfig != null) setValueByPath(toObject, ["functionCallingConfig"], fromFunctionCallingConfig);
	if (getValueByPath(fromObject, ["includeServerSideToolInvocations"]) !== void 0) throw new Error("includeServerSideToolInvocations parameter is only supported in Gemini Developer API mode, not in Gemini Enterprise Agent Platform mode.");
	return toObject;
}
...
function toolToVertex$2(fromObject) {
	...
	const fromComputerUse = getValueByPath(fromObject, ["computerUse"]);
	if (fromComputerUse != null) setValueByPath(toObject, ["computerUse"], fromComputerUse);
	if (getValueByPath(fromObject, ["fileSearch"]) !== void 0) throw new Error("fileSearch parameter is only supported in Gemini Developer API mode, not in Gemini Enterprise Agent Platform mode.");
	const fromGoogleSearch = getValueByPath(fromObject, ["googleSearch"]);
...
function createFileParametersToMldev(fromObject) {
	...
	if (fromFile != null) setValueByPath(toObject, ["file"], fromFile);
	return toObject;
}
...
function internalRegisterFilesParametersToMldev(fromObject) {
	...
	if (fromUris != null) setValueByPath(toObject, ["uris"], fromUris);
	return toObject;
}
...
function audioTranscriptionConfigToMldev$1(fromObject) {
	const toObject = {};
	if (getValueByPath(fromObject, ["languageCodes"]) !== void 0) throw new Error("languageCodes parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	return toObject;
}
...
function generationConfigToVertex$1(fromObject) {
	...
	if (fromSeed != null) setValueByPath(toObject, ["seed"], fromSeed);
	const fromSpeechConfig = getValueByPath(fromObject, ["speechConfig"]);
	if (fromSpeechConfig != null) setValueByPath(toObject, ["speechConfig"], fromSpeechConfig);
	const fromStopSequences = getValueByPath(fromObject, ["stopSequences"]);
	if (fromStopSequences != null) setValueByPath(toObject, ["stopSequences"], fromStopSequences);
	const fromTemperature = getValueByPath(fromObject, ["temperature"]);
	if (fromTemperature != null) setValueByPath(toObject, ["temperature"], fromTemperature);
	...
	const fromTopP = getValueByPath(fromObject, ["topP"]);
	if (fromTopP != null) setValueByPath(toObject, ["topP"], fromTopP);
	if (getValueByPath(fromObject, ["enableEnhancedCivicAnswers"]) !== void 0) throw new Error("enableEnhancedCivicAnswers parameter is only supported in Gemini Developer API mode, not in Gemini Enterprise Agent Platform mode.");
	return toObject;
}
...
function liveConnectConfigToMldev$1(fromObject, parentObject) {
	...
	if (parentObject !== void 0 && fromInputAudioTranscription != null) setValueByPath(parentObject, ["setup", "inputAudioTranscription"], audioTranscriptionConfigToMldev$1(fromInputAudioTranscription));
	const fromOutputAudioTranscription = getValueByPath(fromObject, ["outputAudioTranscription"]);
	if (parentObject !== void 0 && fromOutputAudioTranscription != null) setValueByPath(parentObject, ["setup", "outputAudioTranscription"], audioTranscriptionConfigToMldev$1(fromOutputAudioTranscription));
	...
	if (getValueByPath(fromObject, ["explicitVadSignal"]) !== void 0) throw new Error("explicitVadSignal parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	const fromAvatarConfig = getValueByPath(fromObject, ["avatarConfig"]);
	if (parentObject !== void 0 && fromAvatarConfig != null) setValueByPath(parentObject, ["setup", "avatarConfig"], fromAvatarConfig);
	const fromSafetySettings = getValueByPath(fromObject, ["safetySettings"]);
	if (parentObject !== void 0 && fromSafetySettings != null) {
		let transformedList = fromSafetySettings;
		if (Array.isArray(transformedList)) transformedList = transformedList.map((item) => {
	...
	if (parentObject !== void 0 && fromTranslationConfig != null) setValueByPath(parentObject, [
		"setup",
		"generationConfig",
		"translationConfig"
...
function liveConnectConfigToVertex(fromObject, parentObject) {
	...
	const fromSystemInstruction = getValueByPath(fromObject, ["systemInstruction"]);
	if (parentObject !== void 0 && fromSystemInstruction != null) setValueByPath(parentObject, ["setup", "systemInstruction"], contentToVertex$2(tContent(fromSystemInstruction)));
	const fromTools = getValueByPath(fromObject, ["tools"]);
	if (parentObject !== void 0 && fromTools != null) {
		let transformedList = tTools(fromTools);
		if (Array.isArray(transformedList)) transformedList = transformedList.map((item) => {
	...
	if (parentObject !== void 0 && fromExplicitVadSignal != null) setValueByPath(parentObject, ["setup", "explicitVadSignal"], fromExplicitVadSignal);
	const fromAvatarConfig = getValueByPath(fromObject, ["avatarConfig"]);
	if (parentObject !== void 0 && fromAvatarConfig != null) setValueByPath(parentObject, ["setup", "avatarConfig"], fromAvatarConfig);
	const fromSafetySettings = getValueByPath(fromObject, ["safetySettings"]);
	if (parentObject !== void 0 && fromSafetySettings != null) {
	...
	if (getValueByPath(fromObject, ["translationConfig"]) !== void 0) throw new Error("translationConfig parameter is only supported in Gemini Developer API mode, not in Gemini Enterprise Agent Platform mode.");
	return toObject;
}
...
function liveServerMessageFromVertex(fromObject) {
	...
	const fromVoiceActivityDetectionSignal = getValueByPath(fromObject, ["voiceActivityDetectionSignal"]);
	if (fromVoiceActivityDetectionSignal != null) setValueByPath(toObject, ["voiceActivityDetectionSignal"], fromVoiceActivityDetectionSignal);
	const fromVoiceActivity = getValueByPath(fromObject, ["voiceActivity"]);
	if (fromVoiceActivity != null) setValueByPath(toObject, ["voiceActivity"], voiceActivityFromVertex(fromVoiceActivity));
	return toObject;
}
...
function partToVertex$2(fromObject) {
	...
	if (fromMediaResolution != null) setValueByPath(toObject, ["mediaResolution"], fromMediaResolution);
	const fromCodeExecutionResult = getValueByPath(fromObject, ["codeExecutionResult"]);
	if (fromCodeExecutionResult != null) setValueByPath(toObject, ["codeExecutionResult"], codeExecutionResultToVertex$2(fromCodeExecutionResult));
	const fromExecutableCode = getValueByPath(fromObject, ["executableCode"]);
	if (fromExecutableCode != null) setValueByPath(toObject, ["executableCode"], executableCodeToVertex$2(fromExecutableCode));
	const fromFileData = getValueByPath(fromObject, ["fileData"]);
	if (fromFileData != null) setValueByPath(toObject, ["fileData"], fromFileData);
	const fromFunctionCall = getValueByPath(fromObject, ["functionCall"]);
	if (fromFunctionCall != null) setValueByPath(toObject, ["functionCall"], fromFunctionCall);
...
function sessionResumptionConfigToMldev$1(fromObject) {
	...
	if (getValueByPath(fromObject, ["transparent"]) !== void 0) throw new Error("transparent parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	return toObject;
}
...
function voiceActivityFromVertex(fromObject) {
	...
	if (fromVoiceActivityType != null) setValueByPath(toObject, ["voiceActivityType"], fromVoiceActivityType);
	return toObject;
}
/**
* @license
...
function countTokensConfigToMldev(fromObject, _rootObject) {
	const toObject = {};
	if (getValueByPath(fromObject, ["systemInstruction"]) !== void 0) throw new Error("systemInstruction parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	if (getValueByPath(fromObject, ["tools"]) !== void 0) throw new Error("tools parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	if (getValueByPath(fromObject, ["generationConfig"]) !== void 0) throw new Error("generationConfig parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	return toObject;
}
function countTokensConfigToVertex(fromObject, parentObject, rootObject) {
	const toObject = {};
	const fromSystemInstruction = getValueByPath(fromObject, ["systemInstruction"]);
	if (parentObject !== void 0 && fromSystemInstruction != null) setValueByPath(parentObject, ["systemInstruction"], contentToVertex$1(tContent(fromSystemInstruction)));
	const fromTools = getValueByPath(fromObject, ["tools"]);
	if (parentObject !== void 0 && fromTools != null) {
		let transformedList = fromTools;
		if (Array.isArray(transformedList)) transformedList = transformedList.map((item) => {
...
function embedContentConfigToVertex(fromObject, parentObject, rootObject) {
	...
	if (discriminatorTaskType === void 0) discriminatorTaskType = "PREDICT";
	if (discriminatorTaskType === "PREDICT") {
		...
		const fromTaskType = getValueByPath(fromObject, ["taskType"]);
		if (parentObject !== void 0 && fromTaskType != null) setValueByPath(parentObject, ["embedContentConfig", "taskType"], fromTaskType);
	}
	let discriminatorTitle = getValueByPath(rootObject, ["embeddingApiType"]);
	if (discriminatorTitle === void 0) discriminatorTitle = "PREDICT";
	if (discriminatorTitle === "PREDICT") {
		...
		const fromTitle = getValueByPath(fromObject, ["title"]);
		if (parentObject !== void 0 && fromTitle != null) setValueByPath(parentObject, ["embedContentConfig", "title"], fromTitle);
	}
	let discriminatorOutputDimensionality = getValueByPath(rootObject, ["embeddingApiType"]);
	if (discriminatorOutputDimensionality === void 0) discriminatorOutputDimensionality = "PREDICT";
	if (discriminatorOutputDimensionality === "PREDICT") {
		...
		const fromOutputDimensionality = getValueByPath(fromObject, ["outputDimensionality"]);
		if (parentObject !== void 0 && fromOutputDimensionality != null) setValueByPath(parentObject, ["embedContentConfig", "outputDimensionality"], fromOutputDimensionality);
	}
	let discriminatorMimeType = getValueByPath(rootObject, ["embeddingApiType"]);
	if (discriminatorMimeType === void 0) discriminatorMimeType = "PREDICT";
	...
	if (discriminatorAutoTruncate === void 0) discriminatorAutoTruncate = "PREDICT";
	if (discriminatorAutoTruncate === "PREDICT") {
		...
		const fromAutoTruncate = getValueByPath(fromObject, ["autoTruncate"]);
		if (parentObject !== void 0 && fromAutoTruncate != null) setValueByPath(parentObject, ["embedContentConfig", "autoTruncate"], fromAutoTruncate);
	}
	let discriminatorDocumentOcr = getValueByPath(rootObject, ["embeddingApiType"]);
	if (discriminatorDocumentOcr === void 0) discriminatorDocumentOcr = "PREDICT";
	if (discriminatorDocumentOcr === "EMBED_CONTENT") {
		const fromDocumentOcr = getValueByPath(fromObject, ["documentOcr"]);
		if (parentObject !== void 0 && fromDocumentOcr != null) setValueByPath(parentObject, ["embedContentConfig", "documentOcr"], fromDocumentOcr);
	}
	let discriminatorAudioTrackExtraction = getValueByPath(rootObject, ["embeddingApiType"]);
	if (discriminatorAudioTrackExtraction === void 0) discriminatorAudioTrackExtraction = "PREDICT";
	if (discriminatorAudioTrackExtraction === "EMBED_CONTENT") {
		...
		if (parentObject !== void 0 && fromAudioTrackExtraction != null) setValueByPath(parentObject, ["embedContentConfig", "audioTrackExtraction"], fromAudioTrackExtraction);
	}
	return toObject;
}
function embedContentParametersPrivateToMldev(apiClient, fromObject, rootObject) {
	...
	const fromContent = getValueByPath(fromObject, ["content"]);
	if (fromContent != null) contentToMldev$1(tContent(fromContent));
	const fromConfig = getValueByPath(fromObject, ["config"]);
...
function embedContentParametersPrivateToVertex(apiClient, fromObject, rootObject) {
	...
	if (discriminatorContents === void 0) discriminatorContents = "PREDICT";
	...
	if (discriminatorContent === void 0) discriminatorContent = "PREDICT";
	if (discriminatorContent === "EMBED_CONTENT") {
		const fromContent = getValueByPath(fromObject, ["content"]);
		if (fromContent != null) setValueByPath(toObject, ["content"], contentToVertex$1(tContent(fromContent)));
	}
	const fromConfig = getValueByPath(fromObject, ["config"]);
	if (fromConfig != null) embedContentConfigToVertex(fromConfig, toObject, rootObject);
	return toObject;
}
...
function embedContentResponseFromVertex(fromObject, rootObject) {
	...
	if (rootObject && getValueByPath(rootObject, ["embeddingApiType"]) === "EMBED_CONTENT") {
		...
		if (embedding) {
			const stats = {};
			if (usageMetadata && usageMetadata["promptTokenCount"]) stats.tokenCount = usageMetadata["promptTokenCount"];
			if (truncated) stats.truncated = truncated;
...
function generateContentConfigToVertex(apiClient, fromObject, parentObject, rootObject) {
	...
	const fromToolConfig = getValueByPath(fromObject, ["toolConfig"]);
	if (parentObject !== void 0 && fromToolConfig != null) setValueByPath(parentObject, ["toolConfig"], toolConfigToVertex(fromToolConfig));
	const fromLabels = getValueByPath(fromObject, ["labels"]);
	if (parentObject !== void 0 && fromLabels != null) setValueByPath(parentObject, ["labels"], fromLabels);
	const fromCachedContent = getValueByPath(fromObject, ["cachedContent"]);
	if (parentObject !== void 0 && fromCachedContent != null) setValueByPath(parentObject, ["cachedContent"], tCachedContentName(apiClient, fromCachedContent));
	...
	if (parentObject !== void 0 && fromModelArmorConfig != null) setValueByPath(parentObject, ["modelArmorConfig"], fromModelArmorConfig);
	const fromServiceTier = getValueByPath(fromObject, ["serviceTier"]);
	if (parentObject !== void 0 && fromServiceTier != null) setValueByPath(parentObject, ["serviceTier"], fromServiceTier);
	return toObject;
}
...
function generateImagesConfigToMldev(fromObject, parentObject, _rootObject) {
	const toObject = {};
	if (getValueByPath(fromObject, ["outputGcsUri"]) !== void 0) throw new Error("outputGcsUri parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	if (getValueByPath(fromObject, ["negativePrompt"]) !== void 0) throw new Error("negativePrompt parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	const fromNumberOfImages = getValueByPath(fromObject, ["numberOfImages"]);
	if (parentObject !== void 0 && fromNumberOfImages != null) setValueByPath(parentObject, ["parameters", "sampleCount"], fromNumberOfImages);
	const fromAspectRatio = getValueByPath(fromObject, ["aspectRatio"]);
	if (parentObject !== void 0 && fromAspectRatio != null) setValueByPath(parentObject, ["parameters", "aspectRatio"], fromAspectRatio);
	const fromGuidanceScale = getValueByPath(fromObject, ["guidanceScale"]);
	if (parentObject !== void 0 && fromGuidanceScale != null) setValueByPath(parentObject, ["parameters", "guidanceScale"], fromGuidanceScale);
	if (getValueByPath(fromObject, ["seed"]) !== void 0) throw new Error("seed parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	const fromSafetyFilterLevel = getValueByPath(fromObject, ["safetyFilterLevel"]);
	if (parentObject !== void 0 && fromSafetyFilterLevel != null) setValueByPath(parentObject, ["parameters", "safetySetting"], fromSafetyFilterLevel);
	const fromPersonGeneration = getValueByPath(fromObject, ["personGeneration"]);
	if (parentObject !== void 0 && fromPersonGeneration != null) setValueByPath(parentObject, ["parameters", "personGeneration"], fromPersonGeneration);
	...
	if (getValueByPath(fromObject, ["addWatermark"]) !== void 0) throw new Error("addWatermark parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	if (getValueByPath(fromObject, ["labels"]) !== void 0) throw new Error("labels parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	const fromImageSize = getValueByPath(fromObject, ["imageSize"]);
	if (parentObject !== void 0 && fromImageSize != null) setValueByPath(parentObject, ["parameters", "sampleImageSize"], fromImageSize);
	if (getValueByPath(fromObject, ["enhancePrompt"]) !== void 0) throw new Error("enhancePrompt parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	return toObject;
}
...
function generateVideosConfigToMldev(fromObject, parentObject, rootObject) {
	...
	if (getValueByPath(fromObject, ["outputGcsUri"]) !== void 0) throw new Error("outputGcsUri parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	if (getValueByPath(fromObject, ["fps"]) !== void 0) throw new Error("fps parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	...
	const fromPersonGeneration = getValueByPath(fromObject, ["personGeneration"]);
	if (parentObject !== void 0 && fromPersonGeneration != null) setValueByPath(parentObject, ["parameters", "personGeneration"], fromPersonGeneration);
	if (getValueByPath(fromObject, ["pubsubTopic"]) !== void 0) throw new Error("pubsubTopic parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	const fromNegativePrompt = getValueByPath(fromObject, ["negativePrompt"]);
	if (parentObject !== void 0 && fromNegativePrompt != null) setValueByPath(parentObject, ["parameters", "negativePrompt"], fromNegativePrompt);
	const fromEnhancePrompt = getValueByPath(fromObject, ["enhancePrompt"]);
	if (parentObject !== void 0 && fromEnhancePrompt != null) setValueByPath(parentObject, ["parameters", "enhancePrompt"], fromEnhancePrompt);
	if (getValueByPath(fromObject, ["generateAudio"]) !== void 0) throw new Error("generateAudio parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	...
	if (getValueByPath(fromObject, ["mask"]) !== void 0) throw new Error("mask parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	if (getValueByPath(fromObject, ["compressionQuality"]) !== void 0) throw new Error("compressionQuality parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	if (getValueByPath(fromObject, ["labels"]) !== void 0) throw new Error("labels parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	const fromWebhookConfig = getValueByPath(fromObject, ["webhookConfig"]);
	if (parentObject !== void 0 && fromWebhookConfig != null) setValueByPath(parentObject, ["webhookConfig"], fromWebhookConfig);
	if (getValueByPath(fromObject, ["resizeMode"]) !== void 0) throw new Error("resizeMode parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	return toObject;
}
function generateVideosConfigToVertex(fromObject, parentObject, rootObject) {
	...
	if (parentObject !== void 0 && fromResizeMode != null) setValueByPath(parentObject, ["parameters", "resizeMode"], fromResizeMode);
	return toObject;
}
...
function imageConfigToVertex(fromObject, _rootObject) {
	...
	if (fromImageSize != null) setValueByPath(toObject, ["imageSize"], fromImageSize);
	const fromPersonGeneration = getValueByPath(fromObject, ["personGeneration"]);
	if (fromPersonGeneration != null) setValueByPath(toObject, ["personGeneration"], fromPersonGeneration);
	const fromProminentPeople = getValueByPath(fromObject, ["prominentPeople"]);
	if (fromProminentPeople != null) setValueByPath(toObject, ["prominentPeople"], fromProminentPeople);
	const fromOutputMimeType = getValueByPath(fromObject, ["outputMimeType"]);
...
function partToVertex$1(fromObject, rootObject) {
	...
	if (fromMediaResolution != null) setValueByPath(toObject, ["mediaResolution"], fromMediaResolution);
	const fromCodeExecutionResult = getValueByPath(fromObject, ["codeExecutionResult"]);
	if (fromCodeExecutionResult != null) setValueByPath(toObject, ["codeExecutionResult"], codeExecutionResultToVertex$1(fromCodeExecutionResult));
	const fromExecutableCode = getValueByPath(fromObject, ["executableCode"]);
	if (fromExecutableCode != null) setValueByPath(toObject, ["executableCode"], executableCodeToVertex$1(fromExecutableCode));
	const fromFileData = getValueByPath(fromObject, ["fileData"]);
	if (fromFileData != null) setValueByPath(toObject, ["fileData"], fromFileData);
	const fromFunctionCall = getValueByPath(fromObject, ["functionCall"]);
	if (fromFunctionCall != null) setValueByPath(toObject, ["functionCall"], fromFunctionCall);
...
function createFileSearchStoreConfigToMldev(apiClient, fromObject, parentObject) {
	...
	if (parentObject !== void 0 && fromEmbeddingModel != null) setValueByPath(parentObject, ["embeddingModel"], tModel(apiClient, fromEmbeddingModel));
	return toObject;
}
function createFileSearchStoreParametersToMldev(apiClient, fromObject) {
	const toObject = {};
	const fromConfig = getValueByPath(fromObject, ["config"]);
	if (fromConfig != null) createFileSearchStoreConfigToMldev(apiClient, fromConfig, toObject);
	return toObject;
}
...
var LIBRARY_LABEL = `google-genai-sdk/2.8.0`;
var VERTEX_AI_API_DEFAULT_VERSION = "v1beta1";
var GOOGLE_AI_API_DEFAULT_VERSION = "v1beta";
var MULTI_REGIONAL_LOCATIONS = new Set(["us", "eu"]);
...
var ApiClient = class {
	constructor(opts) {
		...
		if (this.clientOptions.vertexai) {
			...
			if (!(this.clientOptions.project && this.clientOptions.location || this.clientOptions.apiKey) && !this.customBaseUrl) throw new Error("Authentication is not set up. Please provide either a project and location, or an API key, or a custom base URL.");
			...
			if (this.customBaseUrl && !hasConstructorAuth) {
				...
				this.clientOptions.project = void 0;
				this.clientOptions.location = void 0;
			} else if (this.clientOptions.apiKey || this.clientOptions.location === "global") initHttpOptions.baseUrl = "https://aiplatform.googleapis.com/";
			else if (this.clientOptions.project && this.clientOptions.location && MULTI_REGIONAL_LOCATIONS.has(this.clientOptions.location)) initHttpOptions.baseUrl = `https://aiplatform.${this.clientOptions.location}.rep.googleapis.com/`;
	...
	shouldPrependVertexProjectPath(request, httpOptions) {
		if (httpOptions.baseUrl && httpOptions.baseUrlResourceScope === ResourceScope.COLLECTION) return false;
				...
				if (globalDispatcher) {
					...
					for (const sym of symbols) {
						...
						if ((desc === null || desc === void 0 ? void 0 : desc.includes("headers timeout")) || (desc === null || desc === void 0 ? void 0 : desc.includes("body timeout"))) {
							...
							if (typeof currentTimeout === "number") globalDispatcher[sym] = Math.max(currentTimeout, httpOptions.timeout);
						}
					}
				}
	...
	async unaryApiCall(url, requestInit, httpMethod) {
		return this.apiCall(url.toString(), Object.assign(Object.assign({}, requestInit), { method: httpMethod })).then(async (response) => {
			...
			else throw new Error(`exception ${e} sending request`, { cause: e });
		});
	}
				...
				while (true) {
					...
					try {
						...
						if ("error" in chunkJson) {
							...
							if (code >= 400 && code < 600) throw new ApiError({
					...
					while (true) {
						...
						if (trimmedEvent.startsWith(dataPrefix)) {
							const processedChunkString = trimmedEvent.substring(5).trim();
							try {
	...
	async apiCall(url, requestInit) {
		var _a;
		if (!this.clientOptions.httpOptions || !this.clientOptions.httpOptions.retryOptions) return fetch(url, requestInit);
		const retryOptions = this.clientOptions.httpOptions.retryOptions;
		const runFetch = async () => {
			const response = await fetch(url, requestInit);
			if (response.ok) return response;
			if (DEFAULT_RETRY_HTTP_STATUS_CODES.includes(response.status)) throw new Error(`Retryable HTTP Error: ${response.statusText}`);
			throw new import_p_retry.AbortError(`Non-retryable exception ${response.statusText} sending request`);
		};
		return (0, import_p_retry.default)(runFetch, { retries: ((_a = retryOptions.attempts) !== null && _a !== void 0 ? _a : DEFAULT_RETRY_ATTEMPTS) - 1 });
	}
	getDefaultHeaders() {
		const headers = {};
	...
	async getHeadersInternal(httpOptions, url) {
		const headers = new Headers();
		if (httpOptions && httpOptions.headers) for (const [key, value] of Object.entries(httpOptions.headers)) headers.append(key, value);
		if ((httpOptions === null || httpOptions === void 0 ? void 0 : httpOptions.timeout) && httpOptions.timeout > 0) headers.append(SERVER_TIMEOUT_HEADER, String(Math.ceil(httpOptions.timeout / 1e3)));
	...
	*/
	async connect(params) {
		...
		if (this.apiClient.isVertexAI()) {
			...
			if (this.apiClient.getCustomBaseUrl() && !hasStandardAuth) url = websocketBaseUrl;
			else {
		...
		if (this.apiClient.isVertexAI() && transformedModel.startsWith("publishers/")) {
			const project = this.apiClient.getProject();
			const location = this.apiClient.getLocation();
			if (project && location) transformedModel = `projects/${project}/locations/${location}/` + transformedModel;
		}
		let clientMessage = {};
...
var defaultLiveSendClientContentParamerters = { turnComplete: true };
/**
Represents a connection to the API.
	...
	constructor(apiClient) {
		...
		*/
		this.embedContent = async (params) => {
			if (!this.apiClient.isVertexAI()) {
				if (params.model.includes("gemini-embedding-2")) params.contents = tContents(params.contents);
				return await this.embedContentInternal(params);
			}
			if (params.model.includes("gemini") && params.model !== "gemini-embedding-001" || params.model.includes("maas")) {
				const contents = tContents(params.contents);
				if (contents.length > 1) throw new Error("The embedContent API for this model only supports one content at a time.");
		...
		*/
		...
		this.list = async (params) => {
			...
			if (this.apiClient.isVertexAI()) {
				if (!actualParams.config.queryBase) if ((_a = actualParams.config) === null || _a === void 0 ? void 0 : _a.filter) throw new Error("Filtering tuned models list is only supported in Gemini Developer API mode, not in Gemini Enterprise Agent Platform mode.");
			...
			return __asyncGenerator(this, arguments, function* () {
				...
				while (remoteCallCount < maxRemoteCalls) {
					...
					if (functionResponses.length > 0) {
						...
						params.contents = tContents(params.contents).concat(newContents);
					} else break;
				}
			});
	...
	*/
	async embedContentInternal(params) {
		...
		if (this.apiClient.isVertexAI()) {
			...
			path = formatMap(tIsVertexEmbedContentModel(params.model) ? "{model}:embedContent" : "{model}:predict", body["_url"]);
			queryParams = body["_query"];
			delete body["_url"];
			delete body["_query"];
			response = this.apiClient.request({
...
function liveConnectConfigToMldev(fromObject, parentObject) {
	...
	const fromInputAudioTranscription = getValueByPath(fromObject, ["inputAudioTranscription"]);
	if (parentObject !== void 0 && fromInputAudioTranscription != null) setValueByPath(parentObject, ["setup", "inputAudioTranscription"], audioTranscriptionConfigToMldev(fromInputAudioTranscription));
	const fromOutputAudioTranscription = getValueByPath(fromObject, ["outputAudioTranscription"]);
	if (parentObject !== void 0 && fromOutputAudioTranscription != null) setValueByPath(parentObject, ["setup", "outputAudioTranscription"], audioTranscriptionConfigToMldev(fromOutputAudioTranscription));
	const fromRealtimeInputConfig = getValueByPath(fromObject, ["realtimeInputConfig"]);
	if (parentObject !== void 0 && fromRealtimeInputConfig != null) setValueByPath(parentObject, ["setup", "realtimeInputConfig"], fromRealtimeInputConfig);
	const fromContextWindowCompression = getValueByPath(fromObject, ["contextWindowCompression"]);
	if (parentObject !== void 0 && fromContextWindowCompression != null) setValueByPath(parentObject, ["setup", "contextWindowCompression"], fromContextWindowCompression);
...
var FileSearchStores = class extends BaseModule {
	...
	*/
	async downloadMedia(uri, config) {
		...
		if (!pathname.includes("/media/")) throw new Error(`Invalid uri format: ${uri}. Expected to contain /media/`);
		const queryParams = {};
...
var APIError = class APIError extends GeminiNextGenAPIClientError {
...
var APIConnectionTimeoutError = class extends APIConnectionError {
	constructor({ message } = {}) {
		super({ message: message !== null && message !== void 0 ? message : "Request timed out. This is a client-side timeout. You can increase the timeout by setting the `timeout` argument in your request or client http options." });
	}
};
...
var isReadonlyArray = isArrayInternal;
...
async function toFile(value, name, options) {
	...
	if (!(options === null || options === void 0 ? void 0 : options.type)) {
		...
		if (typeof type === "string") options = Object.assign(Object.assign({}, options), { type });
	}
...
var formatRequestDetails = (details) => {
	...
	if (details.headers) details.headers = Object.fromEntries((details.headers instanceof Headers ? [...details.headers] : Object.entries(details.headers)).map(([name, value]) => [name, name.toLowerCase() === "x-goog-api-key" || name.toLowerCase() === "authorization" || name.toLowerCase() === "cookie" || name.toLowerCase() === "set-cookie" ? "***" : value]));
...
var Stream = class Stream {
	...
	*/
	tee() {
		...
		return [new Stream(() => teeIterator(left), this.controller, this.client), new Stream(() => teeIterator(right), this.controller, this.client)];
	}
	/**
...
* SPDX-License-Identifier: Apache-2.0
*/
var LEGACY_LYRIA_MODELS = new Set(["lyria-3-pro-preview", "lyria-3-clip-preview"]);
...
function wrapOutputsAsSteps(data) {
	if (!("outputs" in data) || "steps" in data) return data;
	const { outputs } = data, rest = __rest(data, ["outputs"]);
	return Object.assign(Object.assign({}, rest), { steps: [{
		type: "model_output",
		content: outputs
	}] });
}
...
function maybeRemapLegacyStreamEvent(data) {
	...
	if (typeof eventType !== "string" || !(eventType in LEGACY_EVENT_TYPE_RENAMES)) return data;
	...
	if (eventType === "content.start") {
		...
		let stepContent;
		if (content == null) stepContent = [];
		else if (Array.isArray(content)) stepContent = content;
		else stepContent = [content];
		return Object.assign(Object.assign({}, rest), { step: {
			type: "model_output",
			content: stepContent
		} });
	}
	if (eventType === "interaction.start" || eventType === "interaction.complete") {
		...
		if (isPlainObject(inner)) renamed["interaction"] = wrapOutputsAsSteps(inner);
	}
	return renamed;
}
/**
...
*/
var LegacyLyriaStream = class LegacyLyriaStream extends Stream {
	static fromSSEResponse(response, controller, client) {
			...
			return __asyncGenerator(this, arguments, function* wrappedIterator_1() {
				...
				try {
					for (var _d = true, base_1 = __asyncValues(base), base_1_1; base_1_1 = yield __await(base_1.next()), _a = base_1_1.done, !_a; _d = true) {
						_c = base_1_1.value;
						_d = false;
						yield yield __await(maybeRemapLegacyStreamEvent(_c));
					}
				} catch (e_1_1) {
					e_1 = { error: e_1_1 };
				} finally {
...
var BaseInteractions = class extends APIResource {
	create(params, options) {
		...
		if (isStreaming) return promise;
		let nonStreaming = promise;
		if (needsLegacyLyriaShim) nonStreaming = nonStreaming._thenUnwrap((data) => coerceLegacyInteractionResponse(data));
	...
	*/
	...
	get(id, params = {}, options) {
		...
		if (params === null || params === void 0 ? void 0 : params.stream) return response;
...
function addOutputProperties(interaction) {
	...
	for (let i = steps.length - 1; i >= 0; i--) {
		const anyStep = steps[i];
		if (anyStep.type === "user_input") break;
		if (anyStep.type === "model_output" && anyStep.content) for (let j = anyStep.content.length - 1; j >= 0; j--) {
			const content = anyStep.content[j];
			if (content.type === "image" && !output_image) output_image = content;
			if (content.type === "audio" && !output_audio) output_audio = content;
			if (content.type === "video" && !output_video) output_video = content;
		}
	}
...
var BaseWebhooks = class extends APIResource {
	...
	*/
	update(id, params = {}, options) {
		...
		return this._client.patch(path`/${api_version}/webhooks/${id}`, Object.assign({
			query: { update_mask },
			body
		}, options));
	}
...
async function defaultParseResponse(client, props) {
	...
	const body = await (async () => {
		...
		if ((mediaType === null || mediaType === void 0 ? void 0 : mediaType.includes("application/json")) || (mediaType === null || mediaType === void 0 ? void 0 : mediaType.endsWith("+json"))) {
...
var readEnv = (env) => {
	var _a, _b, _c, _d, _e;
	if (typeof globalThis.process !== "undefined") return ((_b = (_a = globalThis.process.env) === null || _a === void 0 ? void 0 : _a[env]) === null || _b === void 0 ? void 0 : _b.trim()) || void 0;
	if (typeof globalThis.Deno !== "undefined") return ((_e = (_d = (_c = globalThis.Deno.env) === null || _c === void 0 ? void 0 : _c.get) === null || _d === void 0 ? void 0 : _d.call(_c, env)) === null || _e === void 0 ? void 0 : _e.trim()) || void 0;
};
/**
* @license
* Copyright 2025 Google LLC
...
*/
var BaseGeminiNextGenAPIClient = class BaseGeminiNextGenAPIClient {
	/**
	...
	*/
	...
	async authHeaders(opts) {
		...
		if (existingHeaders.values.has("authorization") || existingHeaders.values.has("x-goog-api-key")) return;
		if (this.apiKey) return buildHeaders([{ "x-goog-api-key": this.apiKey }]);
		if (this.clientAdapter && this.clientAdapter.isVertexAI()) return buildHeaders([await this.clientAdapter.getAuthHeaders()]);
	}
	/**
	* Basic re-implementation of `qs.stringify` for primitive types.
	*/
	...
	buildURL(path, query, defaultBaseURL) {
		...
		if (!isEmptyObj(defaultQuery) || !isEmptyObj(pathQuery)) query = Object.assign(Object.assign(Object.assign({}, pathQuery), defaultQuery), query);
	...
	async buildRequest(inputOptions, { retryCount = 0 } = {}) {
		...
		return {
			req: Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({
				method,
				headers: reqHeaders
			}, options.signal && { signal: options.signal }), globalThis.ReadableStream && body instanceof globalThis.ReadableStream && { duplex: "half" }), body && { body }), (_c = this.fetchOptions) !== null && _c !== void 0 ? _c : {}), (_d = options.fetchOptions) !== null && _d !== void 0 ? _d : {}),
			url,
...
function createTuningJobConfigToMldev(fromObject, parentObject, _rootObject) {
	const toObject = {};
	if (getValueByPath(fromObject, ["validationDataset"]) !== void 0) throw new Error("validationDataset parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	...
	if (getValueByPath(fromObject, ["description"]) !== void 0) throw new Error("description parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	...
	if (getValueByPath(fromObject, ["exportLastCheckpointOnly"]) !== void 0) throw new Error("exportLastCheckpointOnly parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	if (getValueByPath(fromObject, ["preTunedModelCheckpointId"]) !== void 0) throw new Error("preTunedModelCheckpointId parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	if (getValueByPath(fromObject, ["adapterSize"]) !== void 0) throw new Error("adapterSize parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	if (getValueByPath(fromObject, ["tuningMode"]) !== void 0) throw new Error("tuningMode parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	if (getValueByPath(fromObject, ["customBaseModel"]) !== void 0) throw new Error("customBaseModel parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	...
	if (getValueByPath(fromObject, ["labels"]) !== void 0) throw new Error("labels parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	if (getValueByPath(fromObject, ["beta"]) !== void 0) throw new Error("beta parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	if (getValueByPath(fromObject, ["baseTeacherModel"]) !== void 0) throw new Error("baseTeacherModel parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	if (getValueByPath(fromObject, ["tunedTeacherModelSource"]) !== void 0) throw new Error("tunedTeacherModelSource parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	if (getValueByPath(fromObject, ["sftLossWeightMultiplier"]) !== void 0) throw new Error("sftLossWeightMultiplier parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	if (getValueByPath(fromObject, ["outputUri"]) !== void 0) throw new Error("outputUri parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	if (getValueByPath(fromObject, ["encryptionSpec"]) !== void 0) throw new Error("encryptionSpec parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	if (getValueByPath(fromObject, ["rewardConfig"]) !== void 0) throw new Error("rewardConfig parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	if (getValueByPath(fromObject, ["compositeRewardConfig"]) !== void 0) throw new Error("compositeRewardConfig parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	if (getValueByPath(fromObject, ["samplesPerPrompt"]) !== void 0) throw new Error("samplesPerPrompt parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	if (getValueByPath(fromObject, ["evaluateInterval"]) !== void 0) throw new Error("evaluateInterval parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	if (getValueByPath(fromObject, ["checkpointInterval"]) !== void 0) throw new Error("checkpointInterval parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	if (getValueByPath(fromObject, ["maxOutputTokens"]) !== void 0) throw new Error("maxOutputTokens parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	if (getValueByPath(fromObject, ["thinkingLevel"]) !== void 0) throw new Error("thinkingLevel parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	if (getValueByPath(fromObject, ["validationDatasetUri"]) !== void 0) throw new Error("validationDatasetUri parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	return toObject;
}
function createTuningJobConfigToVertex(fromObject, parentObject, rootObject) {
	...
	if (discriminatorValidationDataset === "SUPERVISED_FINE_TUNING") {
		...
		const fromValidationDataset = getValueByPath(fromObject, ["validationDataset"]);
		if (parentObject !== void 0 && fromValidationDataset != null) setValueByPath(parentObject, ["distillationSpec"], tuningValidationDatasetToVertex(fromValidationDataset));
	} else if (discriminatorValidationDataset === "REINFORCEMENT_TUNING") {
		const fromValidationDataset = getValueByPath(fromObject, ["validationDataset"]);
		if (parentObject !== void 0 && fromValidationDataset != null) setValueByPath(parentObject, ["reinforcementTuningSpec"], tuningValidationDatasetToVertex(fromValidationDataset));
	}
	const fromTunedModelDisplayName = getValueByPath(fromObject, ["tunedModelDisplayName"]);
	...
	if (discriminatorExportLastCheckpointOnly === "SUPERVISED_FINE_TUNING") {
		...
		const fromExportLastCheckpointOnly = getValueByPath(fromObject, ["exportLastCheckpointOnly"]);
		if (parentObject !== void 0 && fromExportLastCheckpointOnly != null) setValueByPath(parentObject, ["distillationSpec", "exportLastCheckpointOnly"], fromExportLastCheckpointOnly);
	}
	...
	if (discriminatorTuningMode === void 0) discriminatorTuningMode = "SUPERVISED_FINE_TUNING";
	if (discriminatorTuningMode === "SUPERVISED_FINE_TUNING") {
		const fromTuningMode = getValueByPath(fromObject, ["tuningMode"]);
		if (parentObject !== void 0 && fromTuningMode != null) setValueByPath(parentObject, ["supervisedTuningSpec", "tuningMode"], fromTuningMode);
	} else if (discriminatorTuningMode === "DISTILLATION") {
		const fromTuningMode = getValueByPath(fromObject, ["tuningMode"]);
		if (parentObject !== void 0 && fromTuningMode != null) setValueByPath(parentObject, ["distillationSpec", "tuningMode"], fromTuningMode);
	}
	const fromCustomBaseModel = getValueByPath(fromObject, ["customBaseModel"]);
	if (parentObject !== void 0 && fromCustomBaseModel != null) setValueByPath(parentObject, ["customBaseModel"], fromCustomBaseModel);
	let discriminatorBatchSize = getValueByPath(rootObject, ["config", "method"]);
	if (discriminatorBatchSize === void 0) discriminatorBatchSize = "SUPERVISED_FINE_TUNING";
	...
	if (discriminatorLearningRate === void 0) discriminatorLearningRate = "SUPERVISED_FINE_TUNING";
	...
	if (parentObject !== void 0 && fromBaseTeacherModel != null) setValueByPath(parentObject, ["distillationSpec", "baseTeacherModel"], fromBaseTeacherModel);
	const fromTunedTeacherModelSource = getValueByPath(fromObject, ["tunedTeacherModelSource"]);
	if (parentObject !== void 0 && fromTunedTeacherModelSource != null) setValueByPath(parentObject, ["distillationSpec", "tunedTeacherModelSource"], fromTunedTeacherModelSource);
	const fromSftLossWeightMultiplier = getValueByPath(fromObject, ["sftLossWeightMultiplier"]);
	if (parentObject !== void 0 && fromSftLossWeightMultiplier != null) setValueByPath(parentObject, [
		"distillationSpec",
		"hyperParameters",
		"sftLossWeightMultiplier"
	], fromSftLossWeightMultiplier);
	const fromOutputUri = getValueByPath(fromObject, ["outputUri"]);
	if (parentObject !== void 0 && fromOutputUri != null) setValueByPath(parentObject, ["outputUri"], fromOutputUri);
	const fromEncryptionSpec = getValueByPath(fromObject, ["encryptionSpec"]);
	if (parentObject !== void 0 && fromEncryptionSpec != null) setValueByPath(parentObject, ["encryptionSpec"], fromEncryptionSpec);
	const fromRewardConfig = getValueByPath(fromObject, ["rewardConfig"]);
	if (parentObject !== void 0 && fromRewardConfig != null) setValueByPath(parentObject, ["reinforcementTuningSpec", "singleRewardConfig"], fromRewardConfig);
	const fromCompositeRewardConfig = getValueByPath(fromObject, ["compositeRewardConfig"]);
	if (parentObject !== void 0 && fromCompositeRewardConfig != null) setValueByPath(parentObject, ["reinforcementTuningSpec", "compositeRewardConfig"], fromCompositeRewardConfig);
	const fromSamplesPerPrompt = getValueByPath(fromObject, ["samplesPerPrompt"]);
	if (parentObject !== void 0 && fromSamplesPerPrompt != null) setValueByPath(parentObject, [
		"reinforcementTuningSpec",
		"hyperParameters",
		"samplesPerPrompt"
	], fromSamplesPerPrompt);
	const fromEvaluateInterval = getValueByPath(fromObject, ["evaluateInterval"]);
	if (parentObject !== void 0 && fromEvaluateInterval != null) setValueByPath(parentObject, [
		"reinforcementTuningSpec",
		"hyperParameters",
		"evaluateInterval"
	], fromEvaluateInterval);
	const fromCheckpointInterval = getValueByPath(fromObject, ["checkpointInterval"]);
	if (parentObject !== void 0 && fromCheckpointInterval != null) setValueByPath(parentObject, [
		"reinforcementTuningSpec",
		"hyperParameters",
		"checkpointInterval"
	...
	if (parentObject !== void 0 && fromThinkingLevel != null) setValueByPath(parentObject, [
		"reinforcementTuningSpec",
		"hyperParameters",
		"thinkingLevel"
	], fromThinkingLevel);
	const fromValidationDatasetUri = getValueByPath(fromObject, ["validationDatasetUri"]);
	if (parentObject !== void 0 && fromValidationDatasetUri != null) setValueByPath(parentObject, ["reinforcementTuningSpec", "validationDatasetUri"], fromValidationDatasetUri);
	return toObject;
}
...
function distillationHyperParametersFromVertex(fromObject, rootObject) {
	const toObject = {};
	const fromAdapterSize = getValueByPath(fromObject, ["adapterSize"]);
	if (fromAdapterSize != null) setValueByPath(toObject, ["adapterSize"], fromAdapterSize);
	const fromEpochCount = getValueByPath(fromObject, ["epochCount"]);
	if (fromEpochCount != null) setValueByPath(toObject, ["epochCount"], fromEpochCount);
	const fromLearningRateMultiplier = getValueByPath(fromObject, ["learningRateMultiplier"]);
	if (fromLearningRateMultiplier != null) setValueByPath(toObject, ["learningRateMultiplier"], fromLearningRateMultiplier);
	const fromGenerationConfig = getValueByPath(fromObject, ["generationConfig"]);
	if (fromGenerationConfig != null) setValueByPath(toObject, ["generationConfig"], generationConfigFromVertex(fromGenerationConfig));
	const fromLearningRate = getValueByPath(fromObject, ["learningRate"]);
	if (fromLearningRate != null) setValueByPath(toObject, ["learningRate"], fromLearningRate);
	const fromBatchSize = getValueByPath(fromObject, ["batchSize"]);
	if (fromBatchSize != null) setValueByPath(toObject, ["batchSize"], fromBatchSize);
	return toObject;
}
function distillationSamplingSpecFromVertex(fromObject, rootObject) {
	const toObject = {};
	const fromBaseTeacherModel = getValueByPath(fromObject, ["baseTeacherModel"]);
	if (fromBaseTeacherModel != null) setValueByPath(toObject, ["baseTeacherModel"], fromBaseTeacherModel);
	const fromTunedTeacherModelSource = getValueByPath(fromObject, ["tunedTeacherModelSource"]);
	if (fromTunedTeacherModelSource != null) setValueByPath(toObject, ["tunedTeacherModelSource"], fromTunedTeacherModelSource);
	const fromValidationDatasetUri = getValueByPath(fromObject, ["validationDatasetUri"]);
	if (fromValidationDatasetUri != null) setValueByPath(toObject, ["validationDatasetUri"], fromValidationDatasetUri);
	const fromPromptDatasetUri = getValueByPath(fromObject, ["promptDatasetUri"]);
	if (fromPromptDatasetUri != null) setValueByPath(toObject, ["promptDatasetUri"], fromPromptDatasetUri);
	const fromHyperparameters = getValueByPath(fromObject, ["hyperparameters"]);
	if (fromHyperparameters != null) setValueByPath(toObject, ["hyperparameters"], distillationHyperParametersFromVertex(fromHyperparameters));
	return toObject;
}
function distillationSpecFromVertex(fromObject, rootObject) {
	...
	if (fromPipelineRootDirectory != null) setValueByPath(toObject, ["pipelineRootDirectory"], fromPipelineRootDirectory);
	const fromStudentModel = getValueByPath(fromObject, ["studentModel"]);
	if (fromStudentModel != null) setValueByPath(toObject, ["studentModel"], fromStudentModel);
	const fromTrainingDatasetUri = getValueByPath(fromObject, ["trainingDatasetUri"]);
	if (fromTrainingDatasetUri != null) setValueByPath(toObject, ["trainingDatasetUri"], fromTrainingDatasetUri);
	const fromTunedTeacherModelSource = getValueByPath(fromObject, ["tunedTeacherModelSource"]);
	if (fromTunedTeacherModelSource != null) setValueByPath(toObject, ["tunedTeacherModelSource"], fromTunedTeacherModelSource);
	const fromValidationDatasetUri = getValueByPath(fromObject, ["validationDatasetUri"]);
	if (fromValidationDatasetUri != null) setValueByPath(toObject, ["validationDatasetUri"], fromValidationDatasetUri);
	const fromTuningMode = getValueByPath(fromObject, ["tuningMode"]);
	if (fromTuningMode != null) setValueByPath(toObject, ["tuningMode"], fromTuningMode);
	return toObject;
}
...
function generationConfigFromVertex(fromObject, _rootObject) {
	...
	if (fromModelSelectionConfig != null) setValueByPath(toObject, ["modelSelectionConfig"], fromModelSelectionConfig);
	const fromResponseJsonSchema = getValueByPath(fromObject, ["responseJsonSchema"]);
	if (fromResponseJsonSchema != null) setValueByPath(toObject, ["responseJsonSchema"], fromResponseJsonSchema);
	const fromAudioTimestamp = getValueByPath(fromObject, ["audioTimestamp"]);
	if (fromAudioTimestamp != null) setValueByPath(toObject, ["audioTimestamp"], fromAudioTimestamp);
...
function partToVertex(fromObject, rootObject) {
	...
	if (fromMediaResolution != null) setValueByPath(toObject, ["mediaResolution"], fromMediaResolution);
	const fromCodeExecutionResult = getValueByPath(fromObject, ["codeExecutionResult"]);
	if (fromCodeExecutionResult != null) setValueByPath(toObject, ["codeExecutionResult"], codeExecutionResultToVertex(fromCodeExecutionResult));
	const fromExecutableCode = getValueByPath(fromObject, ["executableCode"]);
	if (fromExecutableCode != null) setValueByPath(toObject, ["executableCode"], executableCodeToVertex(fromExecutableCode));
	const fromFileData = getValueByPath(fromObject, ["fileData"]);
	if (fromFileData != null) setValueByPath(toObject, ["fileData"], fromFileData);
	const fromFunctionCall = getValueByPath(fromObject, ["functionCall"]);
	if (fromFunctionCall != null) setValueByPath(toObject, ["functionCall"], fromFunctionCall);
...
function reinforcementTuningExampleToVertex(fromObject, rootObject) {
	...
	if (fromReferences != null) setValueByPath(toObject, ["references"], fromReferences);
	const fromSystemInstruction = getValueByPath(fromObject, ["systemInstruction"]);
	if (fromSystemInstruction != null) setValueByPath(toObject, ["systemInstruction"], contentToVertex(fromSystemInstruction));
	return toObject;
}
...
function tuningDatasetToMldev(fromObject, _rootObject) {
	const toObject = {};
	if (getValueByPath(fromObject, ["gcsUri"]) !== void 0) throw new Error("gcsUri parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
	if (getValueByPath(fromObject, ["vertexDatasetResource"]) !== void 0) throw new Error("vertexDatasetResource parameter is only supported in Gemini Enterprise Agent Platform mode, not in Gemini Developer API mode.");
...
function tuningDatasetToVertex(fromObject, parentObject, rootObject) {
	...
	if (discriminatorGcsUri === "SUPERVISED_FINE_TUNING") {
		...
		const fromGcsUri = getValueByPath(fromObject, ["gcsUri"]);
		if (parentObject !== void 0 && fromGcsUri != null) setValueByPath(parentObject, ["distillationSpec", "promptDatasetUri"], fromGcsUri);
	} else if (discriminatorGcsUri === "REINFORCEMENT_TUNING") {
		const fromGcsUri = getValueByPath(fromObject, ["gcsUri"]);
		if (parentObject !== void 0 && fromGcsUri != null) setValueByPath(parentObject, ["reinforcementTuningSpec", "trainingDatasetUri"], fromGcsUri);
	}
	...
	if (discriminatorVertexDatasetResource === "SUPERVISED_FINE_TUNING") {
		...
		const fromVertexDatasetResource = getValueByPath(fromObject, ["vertexDatasetResource"]);
		if (parentObject !== void 0 && fromVertexDatasetResource != null) setValueByPath(parentObject, ["distillationSpec", "promptDatasetUri"], fromVertexDatasetResource);
	} else if (discriminatorVertexDatasetResource === "REINFORCEMENT_TUNING") {
		const fromVertexDatasetResource = getValueByPath(fromObject, ["vertexDatasetResource"]);
		if (parentObject !== void 0 && fromVertexDatasetResource != null) setValueByPath(parentObject, ["reinforcementTuningSpec", "trainingDatasetUri"], fromVertexDatasetResource);
	}
	if (getValueByPath(fromObject, ["examples"]) !== void 0) throw new Error("examples parameter is only supported in Gemini Developer API mode, not in Gemini Enterprise Agent Platform mode.");
	return toObject;
}
...
function tuningJobFromVertex(fromObject, rootObject) {
	...
	if (fromDistillationSpec != null) setValueByPath(toObject, ["distillationSpec"], distillationSpecFromVertex(fromDistillationSpec));
	const fromReinforcementTuningSpec = getValueByPath(fromObject, ["reinforcementTuningSpec"]);
	if (fromReinforcementTuningSpec != null) setValueByPath(toObject, ["reinforcementTuningSpec"], fromReinforcementTuningSpec);
	...
	if (fromTuningJobMetadata != null) setValueByPath(toObject, ["tuningJobMetadata"], fromTuningJobMetadata);
	const fromVeoLoraTuningSpec = getValueByPath(fromObject, ["veoLoraTuningSpec"]);
	if (fromVeoLoraTuningSpec != null) setValueByPath(toObject, ["veoLoraTuningSpec"], fromVeoLoraTuningSpec);
	const fromDistillationSamplingSpec = getValueByPath(fromObject, ["distillationSamplingSpec"]);
	if (fromDistillationSamplingSpec != null) setValueByPath(toObject, ["distillationSamplingSpec"], distillationSamplingSpecFromVertex(fromDistillationSamplingSpec));
	return toObject;
}
...
function validateRewardParametersToVertex(fromObject, rootObject) {
	...
	if (fromSampleResponse != null) setValueByPath(toObject, ["sampleResponse"], contentToVertex(fromSampleResponse));
	const fromExample = getValueByPath(fromObject, ["example"]);
	if (fromExample != null) setValueByPath(toObject, ["example"], reinforcementTuningExampleToVertex(fromExample));
	const fromSingleRewardConfig = getValueByPath(fromObject, ["singleRewardConfig"]);
	if (fromSingleRewardConfig != null) setValueByPath(toObject, ["singleRewardConfig"], fromSingleRewardConfig);
	const fromCompositeRewardConfig = getValueByPath(fromObject, ["compositeRewardConfig"]);
	if (fromCompositeRewardConfig != null) setValueByPath(toObject, ["compositeRewardConfig"], fromCompositeRewardConfig);
	return toObject;
}
function validateRewardResponseFromVertex(fromObject, _rootObject) {
	...
	if (fromOverallReward != null) setValueByPath(toObject, ["overallReward"], fromOverallReward);
	const fromError = getValueByPath(fromObject, ["error"]);
	if (fromError != null) setValueByPath(toObject, ["error"], fromError);
	const fromRewardInfoDetails = getValueByPath(fromObject, ["rewardInfoDetails"]);
	if (fromRewardInfoDetails != null) setValueByPath(toObject, ["rewardInfoDetails"], fromRewardInfoDetails);
	return toObject;
}
/**
* @license
...
async function uploadBlobInternal(file, uploadUrl, apiClient, httpOptions) {
	...
	while (offset < fileSize) {
		...
		while (retryCount < MAX_RETRY_COUNT) {
			const mergedHeaders = Object.assign(Object.assign({}, (httpOptions === null || httpOptions === void 0 ? void 0 : httpOptions.headers) || {}), {
		...
		offset += chunkSize;
		if (((_c = response === null || response === void 0 ? void 0 : response.headers) === null || _c === void 0 ? void 0 : _c[X_GOOG_UPLOAD_STATUS_HEADER_FIELD]) !== "active") break;
...
var GoogleGenAI = class {
	...
	get webhooks() {
		if (this._webhooks !== void 0) return this._webhooks;
		this._webhooks = this.getNextGenClient().webhooks;
		return this._webhooks;
	}
	get agents() {
		if (this._agents !== void 0) return this._agents;
	...
	constructor(options) {
		...
		const baseUrl = getBaseUrl(options.httpOptions, options.vertexai, void 0, void 0);
		if (baseUrl) if (options.httpOptions) options.httpOptions.baseUrl = baseUrl;
		else options.httpOptions = { baseUrl };
