...
const Login = () => {
    ...
    // Initialize custom Google Login Hook
    const login = useGoogleLogin({
        onSuccess: async (tokenResponse) => {
            console.log("Google Login Token:", tokenResponse);
            // Handle login logic (e.g., send token to your backend)
            navigate("/home");
        },
                ...
                <div className="w-full">
                    ...
                    <form onSubmit={handleFormSubmit} className="space-y-4">
                        <div>
                            ...
                            <input
                                className="border border-gray-300 rounded-xl px-4 py-3 text-sm w-full outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all bg-white text-gray-700"
                                type="email"
                                id="login"
                                required
                            />
                        ...
                        <div className="text-right">
                            <a
                                className="text-xs font-semibold text-gray-500 hover:text-blue-600 cursor-pointer transition-colors"
                                href="#"
                            >
                                Forgot Password?
                            </a>
                        ...
                        {/* Normal Log In Action Button */}
                        <div className="pt-2">
                            <button
                                type="submit"
                                className="w-full py-3 px-4 bg-blue-600 hover:bg-blue-700 focus:ring-blue-500 focus:ring-offset-2 text-white transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 rounded-xl cursor-pointer"
                            >
                                Log in
                            </button>
                        </div>
                    ...
                    {/* Google OAuth Trigger Button Container */}
                    <div className="w-full mb-6">
                        <button
                            type="button"
                            onClick={() => login()}
                            className="flex items-center justify-center w-full py-3 px-4 bg-white border border-gray-300 hover:bg-gray-50 focus:ring-blue-500 text-gray-700 transition ease-in duration-200 text-center text-base font-semibold shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-xl cursor-pointer"
                        >
                            <svg
                                viewBox="0 0 24 24"
                                height="22"
                            ...
                            >
                                ...
                                <path
                                    opacity=".2"
                                    d="M12,0.25c2.9750366,0,5.6829224,1.0983887,7.7792969,2.8916016l0.144165-0.1375122 l-0.110014-0.0958166C17.7089558,1.0843592,15.00354,0,12,0C5.3725586,0,0,5.3725586,0,12c0,0.0421753,0.0058594,0.0828857,0.0062866,0.125C0.0740356,5.5558472,5.4147339,0.25,12,0.25z"
                                    fill="#FFF"
                                ></path>
                            </svg>
                    ...
                    <div className="flex items-center justify-between mt-4">
                        ...
                        <Link className="text-xs text-gray-500 uppercase hover:text-blue-600 hover:underline font-medium" to="/signup">
                            or sign up
                        </Link>
                        <span className="w-1/4 border-b border-gray-200"></span>
                    </div>
